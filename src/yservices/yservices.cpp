...
REGISTRY_YSERVICE(RuntimeGlobalCacheYService)

// ---------------------------------------------------------------------

RuntimeGlobalCacheYService::RuntimeGlobalCacheYService()
    : YServiceBase(RuntimeGlobalCacheYService::name(), {}) {

    TAG = RuntimeGlobalCacheYService::name();
}

// ---------------------------------------------------------------------

bool RuntimeGlobalCacheYService::init() {
    // checking settings
    YLog::info(TAG, "init");
    return true;
}
...
bool RuntimeGlobalCacheYService::deinit() {
    // checking settings
...
void RuntimeGlobalCacheYService::set(const std::string &sName, const std::string &sValue) {
    m_sStringMap[sName] = sValue;
}

// ---------------------------------------------------------------------

bool RuntimeGlobalCacheYService::has(const std::string &sName) {
    return m_sStringMap.find(sName) != m_sStringMap.end();
}

// ---------------------------------------------------------------------

std::string RuntimeGlobalCacheYService::get(const std::string &sName) {
